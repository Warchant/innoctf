...
(function() {
  ...
  checkEligibility = function() {
    var in_ru, is_inno, is_student, ref, ref1, ref2;
    in_ru = (ref = $("#country-select").val()) === "RU";
    is_inno = (ref1 = $("#background-select").val()) === "inno_liceum" || ref1 === "inno_student";
    is_student = (ref2 = $("#background-select").val()) === "inno_liceum" || ref2 === "inno_student" || ref2 === "tatar_student";
    if (!is_student) {
    ...
    return apiCall("POST", "/api/user/create", registrationData).done(function(data) {
      switch (data['status']) {
        case 0:
          ...
          return ga('send', 'event', 'Registration', 'Failure', logType + "::" + data.message);
        case 1:
  ...
  $(function() {
    var index, label, offset, pageTransitionSpeed, sizes, tshirt_options;
